...
class MovieInteractor(private val movieRepository: IMovieRepository) : MovieUseCase {
    override fun getAllMovie(): Flow<id.nanangmaxfi.movieku.core.data.source.Resource<List<Movie>>> = movieRepository.getAllMovie()
    ...
    override fun getDetailMovie(movieId: Int): Flow<id.nanangmaxfi.movieku.core.data.source.Resource<MovieDetail>> = movieRepository.getDetailMovie(movieId)
}